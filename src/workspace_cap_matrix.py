"""Workspace Cap Matrix — SCAFFOLD STUB.

Company lens: Replit (independent; no affiliation).
Bottleneck: Agentic coding workspaces need capability bounds for shell/network/file authority.
...
class WorkspaceCapMatrix:
    ...
    - `evaluate(req)` returns a WorkspaceCapMatrixReceipt
